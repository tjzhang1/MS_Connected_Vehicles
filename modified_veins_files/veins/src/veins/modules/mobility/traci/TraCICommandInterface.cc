...
// Induction Loop variables
double TraCICommandInterface::getInductorOccupancy(std::string nodeId)
{
    return genericGetDouble(CMD_GET_INDUCTIONLOOP_VARIABLE, nodeId, LAST_STEP_OCCUPANCY, RESPONSE_GET_INDUCTIONLOOP_VARIABLE);
}

std::list<std::string> TraCICommandInterface::getInductorIds()
{
