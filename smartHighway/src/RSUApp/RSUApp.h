...
#define UPDATE_TMC_PERIOD 600   // How often to send data to TMC
#define ACCUM_DATA_PERIOD 60   // How often to accumulate network data, must be < UPDATE_TMC_PERIOD
#define BROADCAST_INTERVAL 30  // How often to broadcast to drivers, must be < UPDATE_TMC_PERIOD
enum RSU_MSG_types {
